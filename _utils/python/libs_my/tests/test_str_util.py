...
class StrUtilTest(unittest.TestCase):
  ...
  "a": "账号: ''',\\"\\"\\"113590532\\\\n账户余额;包 "
    ...
    def test_email(self):
        # is_email 测试
        assert str_util.is_email("12345678@123") == False
        assert str_util.is_email("13800138000") == False
        assert str_util.is_email("1234@5678@123.com") == False
        assert str_util.is_email("1234@@123.com") == False
        assert str_util.is_email("1234@123.com")
        ...
        assert str_util.is_email("te..st-3_34.34@163.co-m.cn")
    ...
    def test_credentials_no(self):
        ...
        assert str_util.is_credentials_no("372924199303181624") == False
        assert str_util.is_credentials_no("37292419930318162") == False
        assert str_util.is_credentials_no("441423930304235")
        assert str_util.is_credentials_no(441423930304235)
    ...
    def test_number_format(self):
        ...
        # float
        assert str_util.number_format(12345678.0) == '12,345,678.00'
        assert str_util.number_format('12345678.025') == '12,345,678.03'
        assert str_util.number_format(12345678.025) == '12,345,678.03'
        ...
        assert str_util.number_format(decimal.Decimal(-12345678.025)) == '-12,345,678.03'
        # 0 值
        assert str_util.number_format(0) == '0'
        assert str_util.number_format(decimal.Decimal(0)) == '0'
        assert str_util.number_format(0.0) == '0.00'
        assert str_util.number_format(decimal.Decimal('0.0')) == '0.00'
        assert str_util.number_format(decimal.Decimal(0).quantize(decimal.Decimal('0.00'))) == '0.00'
